...
class CopyLink {
    ...
    constructor(elementToObserve, getIssueFunc, keepAlive = false) {
    ...
    #handleMutations(mutationsList, observer) {
        ...
        // Check if the popup has been added to the DOM
        ...
        if (elmContainer) {
            ...
            this.#createButton(elmContainer, issue);
    ...
    #createButton(parentElement, issueKey) {
